...
# Template: app
# Command: C:\Qt\Qt5.7.1\5.7\mingw53_32\bin\qmake.exe -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile FluidSim.pro
#############################################################################
...
Makefile: FluidSim.pro C:/Qt/Qt5.7.1/5.7/mingw53_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.7.1/5.7/mingw53_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile FluidSim.pro
